#ifndef FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_COORD_H
#define FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_COORD_H
...
#endif //FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_COORD_H
