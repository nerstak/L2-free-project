#ifndef FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_QUEUE_H
#define FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_QUEUE_H
...
#endif //FREE_PROJECT_ENGINE_GAME_DUNGEON_UTILS_QUEUE_H
