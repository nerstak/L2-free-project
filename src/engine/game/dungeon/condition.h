#ifndef FREE_PROJECT_ENGINE_GAME_DUNGEON_CONDITION_H
#define FREE_PROJECT_ENGINE_GAME_DUNGEON_CONDITION_H
...
#endif //FREE_PROJECT_ENGINE_GAME_DUNGEON_CONDITION_H
