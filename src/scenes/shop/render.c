...
static void confirmationBlit(Data* data, ImageCollector* myImageCollector, SDL_Surface* shop, TTF_Font* font1);
...
static SDL_Surface* getShop(ImageCollector* myImageCollector, FontCollector* myFontCollector, Data* data, Engine* engine) {
    ...
    //Font init
    TTF_Font* font1 = NULL;
    font1 = get_FontCollector(myFontCollector, "menu/30")->font;
    TTF_Font* font2 = NULL;
    font2 = get_FontCollector(myFontCollector, "menu/40")->font;
    TTF_Font* font3 = NULL;
    font3 = get_FontCollector(myFontCollector, "menu/20")->font;

    backgroundBlit(data, engine, myImageCollector, shop);

    dialogBlit(data, shop, font1);
    moneyBlit(data, shop, font2);

    framesBlit(data, myImageCollector, shop, font1);
    itemsBlit(data, myImageCollector, shop, font1);

    confirmationBlit(data, myImageCollector, shop, font3);
